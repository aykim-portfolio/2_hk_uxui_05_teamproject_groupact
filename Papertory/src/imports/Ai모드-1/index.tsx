import svgPaths from "./svg-aje7ju6295";
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[-5.5px] top-0">
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[147px] top-0 w-[43px]">
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[293.5px] top-0">
...
function Segment1() {
  return <div className="bg-[#e6f997] flex-[1_0_0] h-[2px] min-w-px relative" data-name="segment" />;
}
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-[325px]">
      <Frame6 />
      <Track />
    </div>
  );
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <div className="bg-[#ecf0f9] content-stretch flex items-start px-[24px] py-[4px] relative rounded-[24px] shrink-0" data-name="category chip">
        <div aria-hidden className="absolute border-3 border-solid border-white inset-[-3px] pointer-events-none rounded-[27px]" />
        <p className="[word-break:break-word] font-['Open_Sans:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#496de0] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
          투자업계 시각
        </p>
      </div>
      <div className="relative shrink-0 w-full" data-name="AI카드내용">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[4px] relative size-full">
            <p className="[word-break:break-word] flex-[1_0_0] font-['Open_Sans:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[20px] min-w-px opacity-80 relative text-[#161f85] text-[12px]" style={{ fontVariationSettings: '"wdth" 100' }}>{`투자업계는 "지면형 UX가 체류시간을 늘릴 것"이라 보는 반면, 일부 개발진은 "제스처 학습 비용"을 우려한다.`}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start pt-[16px] relative shrink-0 w-full">
      ...
      <div className="relative shrink-0 w-full" data-name="AI카드내용">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[4px] relative size-full">
            <p className="[word-break:break-word] flex-[1_0_0] font-['Open_Sans:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[20px] min-w-px opacity-80 relative text-[#161f85] text-[12px]" style={{ fontVariationSettings: '"wdth" 100' }}>
              부동산업계는 이런저런 생각을 하다가 그냥 자기로 했다
            </p>
          </div>
        </div>
      </div>
...
function Component() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative rounded-[24px] shrink-0 w-full" data-name="뉴스내용">
      <div className="bg-[#eff1f5] content-stretch drop-shadow-[2px_2px_4px_#d3d8e9] flex flex-col gap-[32px] items-start px-[16px] py-[12px] relative rounded-[24px] shrink-0 w-[353px]" data-name="AI요약">
        <div className="content-stretch flex items-center justify-center px-[4px] relative shrink-0 w-[321px]" data-name="AI카드내용">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Paperlogy:7_Bold',sans-serif] leading-[20px] min-w-px not-italic opacity-80 relative text-[#161f85] text-[18px]">다양한 시각 읽어보기</p>
        </div>
        <Frame14 />
      </div>
    </div>
...
function Frame16() {
  return <div className="h-[100px] relative shrink-0 w-[393px]" />;
}

export default function Ai() {
  return (
    <div className="bg-[#f8f9fb] relative rounded-[40px] size-full" data-name="AI모드">
      <div className="content-stretch flex flex-col items-center min-h-[inherit] overflow-clip pb-[12px] relative rounded-[inherit] size-full">
        ...
        <div className="content-stretch drop-shadow-[0px_2px_1px_rgba(181,181,181,0.25)] flex h-[52px] items-center justify-between px-[16px] relative shrink-0 w-[393px]" data-name="main-header">
          ...
          <div className="content-stretch flex gap-[8px] h-[40px] items-center justify-center opacity-0 pl-[24px] pr-[20px] py-[12px] relative rounded-[24px] shrink-0" data-name="dropdown-tab">
            ...
            <div aria-hidden className="absolute border border-[#afc1fa] border-solid inset-0 pointer-events-none rounded-[24px] shadow-[0px_0px_0.3px_0px_rgba(219,219,219,0.25),4px_4px_16px_0px_rgba(0,0,0,0.12)]" />
        ...
        <div className="relative rounded-[36px] shrink-0 w-full" data-name="slider-AI모드">
          <div className="overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex flex-col items-start pb-[12px] pt-[10px] px-[20px] relative size-full">
              <Frame7 />
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-[56px] content-stretch flex items-center justify-center p-[20px] right-[27px] rounded-[9999px] shadow-[0px_0px_0.3px_0px_rgba(219,219,219,0.25),4px_4px_16px_0px_rgba(0,0,0,0.12)]" data-name="Floating_Action_Button">
          ...
          <div className="overflow-clip relative shrink-0 size-[24px]" data-name="icons">
            <div className="absolute inset-[16.67%_8.33%_16.67%_12.5%]" data-name="Vector">
              <div className="absolute inset-[-6.25%_-5.26%]">
                <svg className="block size-full" fill="none" height="18" preserveAspectRatio="none" viewBox="0 0 21 18" width="21">
                  <path d={svgPaths.pec49540} id="Vector" stroke="var(--stroke-0, #5E82F4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                </svg>
              </div>
            </div>
          </div>
